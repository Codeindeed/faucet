...
impl Challenge4 {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let data = Challenge4InstructionData::new().try_to_vec().unwrap();
...
pub struct Challenge4InstructionData {
    discriminator: u8,
}

impl Challenge4InstructionData {
    pub fn new() -> Self {
        Self { discriminator: 4 }
    }
}

/// Instruction builder for `Challenge4`.
///
/// ### Accounts:
///
///   0. `[writable]` asset
...
/// `challenge4` CPI accounts.
pub struct Challenge4CpiAccounts<'a, 'b> {
    /// The Core asset to burn
...
/// `challenge4` CPI instruction.
pub struct Challenge4Cpi<'a, 'b> {
...
impl<'a, 'b> Challenge4Cpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: Challenge4CpiAccounts<'a, 'b>,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `Challenge4` via CPI.
///
/// ### Accounts:
///
///   0. `[writable]` asset
...
///   5. `[]` mpl_core_program
///   6. `[]` system_program
pub struct Challenge4CpiBuilder<'a, 'b> {
    instruction: Box<Challenge4CpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> Challenge4CpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(Challenge4CpiBuilderInstruction {
            __program: program,
            asset: None,
            collection: None,
            owner: None,
...
struct Challenge4CpiBuilderInstruction<'a, 'b> {
