...
impl Challenge2 {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let data = Challenge2InstructionData::new().try_to_vec().unwrap();
...
pub struct Challenge2InstructionData {
    discriminator: u8,
}

impl Challenge2InstructionData {
    pub fn new() -> Self {
        Self { discriminator: 2 }
    }
}

/// Instruction builder for `Challenge2`.
///
/// ### Accounts:
///
///   0. `[writable]` asset
...
/// `challenge2` CPI accounts.
pub struct Challenge2CpiAccounts<'a, 'b> {
    /// The Core asset to burn
...
/// `challenge2` CPI instruction.
pub struct Challenge2Cpi<'a, 'b> {
...
impl<'a, 'b> Challenge2Cpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: Challenge2CpiAccounts<'a, 'b>,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `Challenge2` via CPI.
///
/// ### Accounts:
///
///   0. `[writable]` asset
...
///   5. `[]` mpl_core_program
///   6. `[]` system_program
pub struct Challenge2CpiBuilder<'a, 'b> {
    instruction: Box<Challenge2CpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> Challenge2CpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(Challenge2CpiBuilderInstruction {
            __program: program,
            asset: None,
            collection: None,
            owner: None,
...
struct Challenge2CpiBuilderInstruction<'a, 'b> {
