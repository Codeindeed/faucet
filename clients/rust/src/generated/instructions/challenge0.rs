...
impl Challenge0 {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let data = Challenge0InstructionData::new().try_to_vec().unwrap();
...
pub struct Challenge0InstructionData {
    discriminator: u8,
}

impl Challenge0InstructionData {
    pub fn new() -> Self {
        Self { discriminator: 0 }
    }
}

/// Instruction builder for `Challenge0`.
///
/// ### Accounts:
///
///   0. `[writable]` asset
...
/// `challenge0` CPI accounts.
pub struct Challenge0CpiAccounts<'a, 'b> {
    /// The Core asset to burn
...
/// `challenge0` CPI instruction.
pub struct Challenge0Cpi<'a, 'b> {
...
impl<'a, 'b> Challenge0Cpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: Challenge0CpiAccounts<'a, 'b>,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `Challenge0` via CPI.
///
/// ### Accounts:
///
///   0. `[writable]` asset
...
///   5. `[]` mpl_core_program
///   6. `[]` system_program
pub struct Challenge0CpiBuilder<'a, 'b> {
    instruction: Box<Challenge0CpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> Challenge0CpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(Challenge0CpiBuilderInstruction {
            __program: program,
            asset: None,
            collection: None,
            owner: None,
...
struct Challenge0CpiBuilderInstruction<'a, 'b> {
