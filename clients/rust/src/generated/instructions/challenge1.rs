...
impl Challenge1 {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let data = Challenge1InstructionData::new().try_to_vec().unwrap();
...
pub struct Challenge1InstructionData {
    discriminator: u8,
}

impl Challenge1InstructionData {
    pub fn new() -> Self {
        Self { discriminator: 1 }
    }
}

/// Instruction builder for `Challenge1`.
///
/// ### Accounts:
///
///   0. `[writable]` asset
...
/// `challenge1` CPI accounts.
pub struct Challenge1CpiAccounts<'a, 'b> {
    /// The Core asset to burn
...
/// `challenge1` CPI instruction.
pub struct Challenge1Cpi<'a, 'b> {
...
impl<'a, 'b> Challenge1Cpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: Challenge1CpiAccounts<'a, 'b>,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `Challenge1` via CPI.
///
/// ### Accounts:
///
///   0. `[writable]` asset
...
///   5. `[]` mpl_core_program
///   6. `[]` system_program
pub struct Challenge1CpiBuilder<'a, 'b> {
    instruction: Box<Challenge1CpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> Challenge1CpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(Challenge1CpiBuilderInstruction {
            __program: program,
            asset: None,
            collection: None,
            owner: None,
...
struct Challenge1CpiBuilderInstruction<'a, 'b> {
